      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-6">
          <form onSubmit={handleSearch} className="flex gap-2 mb-4">
            ...
            <button type="submit" className="px-4 py-2.5 bg-green-700 text-white rounded-xl text-sm font-medium hover:bg-green-800 transition-colors">
              Search
            </button>
          </form>
          ...
          <div className="space-y-2">
            {companies.map((company) => (
              <Link
                ...
                className="flex items-center gap-4 bg-white rounded-2xl border border-gray-100 p-4 hover:border-green-200 hover:shadow-sm transition-all"
              >
                {/* Logo */}
                ...
                {company.approval_rate !== null && (
                  <div className="shrink-0 text-right">
                    <p className={cn(
                      ...
                      company.approval_rate >= 0.95 ? "text-green-600" : company.approval_rate >= 0.8 ? "text-yellow-600" : "text-red-600"
                    )}>
