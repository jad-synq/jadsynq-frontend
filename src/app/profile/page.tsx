                ...
                <div className="px-5 py-4 space-y-3">
                  ...
                  <div className="flex gap-2 pt-1">
                    ...
                    <button
                      ...
                      <Search className="w-3 h-3" /> Delete
                    </button>
                  </div>
                </div>
              ) : (
                <div className="px-5 py-4 space-y-3">
                  <p className="text-sm text-gray-500">No resume saved yet.</p>
                  <Link href="/resume-builder"
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#16a34a] hover:underline">
                    <FileText className="w-3.5 h-3.5" /> Build in Resume Builder →
                  </Link>
                  <div>
                    <p className="text-xs font-semibold text-gray-600 mb-2">Or paste your resume text:</p>
                    <textarea
                      value={resumePaste}
                      onChange={e => setResumePaste(e.target.value)}
                      placeholder="Paste resume as plain text here…"
                      rows={4}
